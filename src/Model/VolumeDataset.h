...
class VolumeDataset
{
	public:
		...
		VolumeDataset(VolumeDataset&&) = default;
		VolumeDataset& operator=(VolumeDataset&&) = default;
		...
		const R64 GetMinInDoubleRange() const
		{
			return m_minInDouble;
		}
	private:
